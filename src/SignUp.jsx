     ...
     ,backdropFilter:"blur(50px)"}}>
      ...
      <div className="wrapper">
        <div className="form-wrapper">
          <h3 style={{padding:"20px",color:"white",}}>Sign Up</h3>
          ...
          <form className="form-group"  onSubmit={this.handleSubmit} noValidate>
            ...
            <div className="createAccount" style={{float:"center",marginTop:"18px"}}>
              <button style={{borderRadius:"5px",border:"none",marginRight:"10px"}} type="submit">Sign Up</button>
              <small ><a href="./carousels2" style={{color:"white"}}>Log In</a></small>
            </div>
          </form>
        </div>
      </div>
